...
def blake2b(data: bytes, digest_size: int = ..., key: bytes = ..., salt: bytes = ..., person: bytes = ..., encoder: nacl.encoding.Encoder = ...) -> bytes:
    """
...
generichash = ...
def siphash24(message: bytes, key: bytes = ..., encoder: nacl.encoding.Encoder = ...) -> bytes:
    """
...
shorthash = ...
def siphashx24(message: bytes, key: bytes = ..., encoder: nacl.encoding.Encoder = ...) -> bytes:
    """

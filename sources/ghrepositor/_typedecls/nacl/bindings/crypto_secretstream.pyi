...
def crypto_secretstream_xchacha20poly1305_push(state: crypto_secretstream_xchacha20poly1305_state, m: bytes, ad: Optional[bytes] = ..., tag: int = ...) -> bytes:
    """
...
def crypto_secretstream_xchacha20poly1305_pull(state: crypto_secretstream_xchacha20poly1305_state, c: bytes, ad: Optional[bytes] = ...) -> Tuple[bytes, int]:
    """

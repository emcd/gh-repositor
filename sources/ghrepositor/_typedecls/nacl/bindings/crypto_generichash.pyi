...
_OVERLONG = ...
_TOOBIG = ...
def generichash_blake2b_salt_personal(data: bytes, digest_size: int = ..., key: bytes = ..., salt: bytes = ..., person: bytes = ...) -> bytes:
...
def generichash_blake2b_init(key: bytes = ..., salt: bytes = ..., person: bytes = ..., digest_size: int = ...) -> Blake2State:
    """

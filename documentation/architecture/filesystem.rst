...
.. code-block::
    ...
    sources/
    ├── ghrepositor/          # Main Python package
    │   ├── __/                      # Centralized import hub
    │   │   ├── __init__.py          # Re-exports core utilities
    │   │   ├── imports.py           # External library imports
    │   │   └── nomina.py            # gh-repositor-specific naming constants
    │   ├── __init__.py              # Package entry point
    │   ├── py.typed                 # Type checking marker
    │   ├── __main__.py              # CLI entry point for `python -m ghrepositor`
...
.. code-block::
    ...
    ghrepositor/
    ├── __main__.py      # Entry point: `python -m ghrepositor`
...
Package-wide exceptions are centralized in ``sources/ghrepositor/exceptions.py``

...
def _import_version( ):
    ...
    module = import_module( 'ghrepositor' )
...
linkcheck_ignore = [
    ...
    r'https://emcd\.github\.io/gh-repositor/.*',
    ...
    r'https://github\.com/emcd/gh-repositor',
    r'https://github\.com/emcd/gh-repositor/.*',
    # Package does not exist during initial development.
    r'https://pypi.org/project/gh-repositor/',
